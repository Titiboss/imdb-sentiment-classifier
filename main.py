...
for name, classifier in classifiers:
    if name == 'DNN':
        classifier.fit(X_train, tf.keras.utils.to_categorical(y_train), epochs=10, batch_size=32)
...
avis = st.text_area("Entrez un avis de film en anglais pour tester","The movie was good. The animation and the graphics were good. I would recommend this movie.")
